...
The system leverages Kafka streaming for data processing. Below are the Kafka topics integrated into the application:

| **Topic Name**                         | **Data Catalog Link**                                                                                                   | **Steward Contact**        |
|----------------------------------------|-----------------------------------------------------------------------------------------------------------------------|----------------------------|
| `Location Datahub Kafka`               | [Link](https://datacatalog.epam.com/data/data-details/574882/summary?utm_source=onehub-assistant&utm_medium=widget)  | Not specified             |
| `Office Datahub Kafka`                 | [Link](https://datacatalog.epam.com/data/data-details/578343/summary?utm_source=onehub-assistant&utm_medium=widget)  | Not specified             |
| `Relevant_Proposal_to_Position_Kafka` | [Link](https://datacatalog.epam.com/data/data-details/622664/summary?utm_source=onehub-assistant&utm_medium=widget)  | Not specified             |
